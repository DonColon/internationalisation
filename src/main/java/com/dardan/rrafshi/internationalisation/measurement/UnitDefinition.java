...
public enum UnitDefinition
{
    ...
    MICROGRAM(new Unit(UnitCategory.MASS, "�g", "Mikrogram", new BigDecimal("1.0E-6"))),
    ...
    MICROSECOND(new Unit(UnitCategory.TIME, "�s", "Microsecond", new BigDecimal("1E-6"))),
    ...
    SQUARE_MICROMETER(new Unit(UnitCategory.AREA, "�m�", "Square Mikrometer", new BigDecimal("1.0E-12"))),
    SQUARE_NANOMETER(new Unit(UnitCategory.AREA, "nm�", "Square Nanometer", new BigDecimal("1.0E-18"))),
    SQUARE_ANGSTROM(new Unit(UnitCategory.AREA, "Ų", "Square �ngstrom", new BigDecimal("1.0E-20"))),
    ...
    MICROAMPERE(new Unit(UnitCategory.CURRENT, "�A", "Microampere", new BigDecimal("1.0E-6"))),
    ...
    MICROCOULOMB(new Unit(UnitCategory.ELECTRIC_CHARGE, "�C", "Microcoulomb", new BigDecimal("1.0E-6"))),
